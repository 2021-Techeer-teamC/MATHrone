...
public class WorkBookService {
    ...
    @Autowired
    public WorkBookService(WorkBookRepository workBookRepository, LevelRepository levelRepository, UserWorkbookRepository userWorkbookRepository, ProblemRepository problemRepository){
